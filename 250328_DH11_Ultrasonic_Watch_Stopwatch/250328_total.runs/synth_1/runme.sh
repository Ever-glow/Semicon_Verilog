...
HD_PWD='C:/work/verilog/250328_total/250328_total.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_total.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_total.tcl
