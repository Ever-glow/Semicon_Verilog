...
HD_PWD='C:/work/verilog/250328_total/250328_total.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_total.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_total.tcl -notrace
