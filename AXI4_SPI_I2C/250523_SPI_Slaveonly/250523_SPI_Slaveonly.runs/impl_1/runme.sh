...
HD_PWD='C:/work/CPUDesignandVerification/250523_SPI_Slaveonly/250523_SPI_Slaveonly.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Slave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_Slave.tcl -notrace
